...
import com.ccaroni.kreasport.legacy.view.activities.downloads.DownloadedRacesActivity;
import com.ccaroni.kreasport.legacy.view.activities.records.MyRecordsActivity;
...
//        });
    ...
    private class OpenIDCallback implements BaseCallback<UserProfile, AuthenticationException> {
        ...
        public void onSuccess(final UserProfile userInfo) {
            Log.d(LOG, "got simple data, attempting to get full profile");
...
//                            .transition(Glide.withCrossFade().crossFade(750))
    ...
    private class ProfileCallback implements BaseCallback<UserProfile, ManagementException> {
        ...
        public void onSuccess(final UserProfile profile) {
            userProfile = profile;
            Log.d(LOG, "got full user profile");
            setUserData();
